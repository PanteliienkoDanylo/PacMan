...
public class Level6 extends LevelBase {
	public Level6() {
		...
		monsters = new Monster[] {
					new MonsterGraphBFS(800, new Point(7,14), this),
					new MonsterHorizontal(850, new Point(1,8), this),
					new MonsterHorizontal(820, new Point(14,9), this),
					new MonsterVertical(840, new Point(1,14), this),
					new MonsterVertical(900, new Point(8,4), this),
					new MonsterVertical(880, new Point(10,6), this),
					new MonsterVertical(700, new Point(14,1), this),
				};
